...
- 🔭 **I’m currently building:** A **Jarvis-inspired Virtual Keyboard** using AI and Gesture Control.
- 🌱 **My focus is on:** `Generative AI`, `Google Cloud`, `TensorFlow`, and `Advanced Data Analytics`.
- 🤝 **I’m open to collaborating on:** **AirSense+**, an Air Quality Visualizer & Forecast App.
- 💡 **I'm seeking collaborators/mentors for:** My final year project on **AI + IoT for Mahakumbh 2026**.
- ✍️ **I share my learnings on my** [**Medium Blog**](https://medium.com/@karankailashrathod9765).
- 💬 **Feel free to ask me about:** `AI/ML`, `GCP`, `Data Analytics`, and even `Video Editing`!
- ⚡ **Fun fact:** I blend pixels and Python - a video editor by hobby, a coder by passion!
...
<details>
  <summary><strong>🛢️ Databases & Backend</strong></summary>
  <br>
  <p align="left">
